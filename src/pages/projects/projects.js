          ...
          <div className="projects-wrapper">
            <div className="project_item">
              <div className="project_item__img">
                <a
                  href="https://college-timetable.herokuapp.com/"
                  target="_blank"
              ...
              <div className="project_item__description">
                ...
                <p>
                  Прогрессивное web-приложение для просмотра расписания занятий,
                  звонов, замен. Разработанное с использованием React, Node,
                  Express, MongoDB.
                </p>
                <div className="project_item__links">
                  <div className="link">
                    <a
                      href="https://github.com/AndreyCJ/college-timetable-app"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      GitHub
            ...
            <div className="project_item">
              <div className="project_item__img">
                <a
                  href="https://1school-wptheme.000webhostapp.com/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <ImageContainer
              ...
              <div className="project_item__description">
                ...
                <p>
                  Wordpress сайт с поддержкой настраемового слайдера, постов,
                  поиска по сайту, виджетов.
                </p>
                <div className="project_item__links">
                  <div className="link">
                    <a
                      href="https://github.com/AndreyCJ/1school_WpTheme"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      GitHub
            ...
            <div className="project_item">
              <div className="project_item__img">
                <a
                  href="https://vanillajsnotesapp.000webhostapp.com/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <ImageContainer
              ...
              <div className="project_item__description">
                ...
                <p>
                  SPA приложение для заметок, разработанное с применением
                  техники асинхронного рендеринга AJAX на чистом JavaScript,
                  PHP, MySQL.
                </p>
                <div className="project_item__links">
                  <div className="link">
                    <a
                      href="https://github.com/AndreyCJ/NotesApp"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      GitHub
